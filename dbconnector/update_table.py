...
def update_table(table_name, data):
    ...
    try:
        ...
        cursor = conn.cursor()
        eid = int(data[0])
        query = "UPDATE employee SET Employee_Id = %s, Name = %s, Date_of_Birth = %s, Gender = %s, Address = %s, Contact = %s, Email = %s, Joining_Date = %s, Department = %s, Job_Id = %s WHERE employee_id = %s"
